...
/**
 * Port for communication with the remote server API.
 * This is an output port — the application depends on this interface,
...
interface ServerApiPort {
    ...
    fun postAuthorDistances(authorDistanceList: List<AuthorDistance>): Result<Unit>
}
